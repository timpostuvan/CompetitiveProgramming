...
- when we do this move we reduce time by at least one so this move is better than just swapping positions i and j (element at position k is closer to his ending position)
*/
